...
{
    public class AddedTipPageViewModel : ViewModelBase
    {
        ...
        public AddedTipPageViewModel(INavigationService navigationService,
        ...
        public override void OnNavigatedTo(INavigationParameters parameters)
        {
            ...
            if (parameters.ContainsKey(Constants.order))
            {
                ...
                Tip = parameters.GetValue<Tip>(Constants.tip);
            }
        }
