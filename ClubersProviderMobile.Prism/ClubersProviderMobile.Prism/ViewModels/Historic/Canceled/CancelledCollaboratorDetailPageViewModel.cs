...
{
    public class CancelledCollaboratorDetailPageViewModel : ViewModelBase
    {
        ...
        public CancelledCollaboratorDetailPageViewModel(INavigationService navigationService, IApiService apiService, IPageDialogService dialogService) : base(navigationService)
        {
            Title = "Detalle";
