...
{
    public class OnSiteOrderDetailPageViewModel : ViewModelBase
    {
        ...
        public OnSiteOrderDetailPageViewModel(INavigationService navigationService,
            IApiService apiService) : base(navigationService)
        {
            _navigationService = navigationService;
            _apiService = apiService;
            Title = "Detalle En Sitio";
        }
